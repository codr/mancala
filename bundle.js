...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.applyMiddleware)(_firebase.firebaseMiddleware, _firebase.skipPreviousAnimations)(_redux.createStore)(_reducers2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayersBoard = __webpack_require__(187);
	
	var _PlayersBoard2 = _interopRequireDefault(_PlayersBoard);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(_PlayersBoard2.default, null);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnimatedBoard = __webpack_require__(188);
	
	var _AnimatedBoard2 = _interopRequireDefault(_AnimatedBoard);
	...
	var PlayersBoard = function (_Component) {
	  _inherits(PlayersBoard, _Component);
	
	  function PlayersBoard(props) {
	    _classCallCheck(this, PlayersBoard);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PlayersBoard).call(this, props));
	    ...
	    // method bindings
	    _this.onHoleClick = _this.onHoleClick.bind(_this);
	    return _this;
	  }
	
	  _createClass(PlayersBoard, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this2 = this;
	
	      (0, _auth.onPlayerNumber)(function (playerNumber) {
	        _this2.setState({ playerNumber: playerNumber });
	      });
	    }
	  }, {
	    key: 'invertBoard',
	    value: function invertBoard(board) {
	      // Careful not to alter the original data.
	      return [board[1].slice(0).reverse(), board[0].slice(0).reverse()];
	    }
	  }, {
	    key: 'invertAnimations',
	    value: function invertAnimations(animationSteps) {
	      var _this3 = this;
	
	      // Here we can modify the data because
	      // the animation step are 1 time use.
	      return animationSteps.map(function (step) {
	        switch (step.type) {
	          case 'MOVE_BEAD':
	            step.start = _this3.invertHole(step.start);
	            step.end = _this3.invertHole(step.end);
	            break;
	          case 'CAPTURE_HOLE':
	            step.hole = _this3.invertHole(step.hole);
	            break;
	        }
	        return step;
	      });
	    ...
	    key: 'normalizedProps',
	    value: function normalizedProps(props) {
	    ...
	    key: 'invertHole',
	    value: function invertHole(_ref) {
	      var row = _ref.row;
	    ...
	    key: 'getRealHole',
	    value: function getRealHole(row, column) {
	      if (this.state.playerNumber !== 0) return { row: row, column: column };
	      return this.invertHole({ row: row, column: column });
	    }
	  }, {
	    key: 'onHoleClick',
	    value: function onHoleClick(row, column) {
	      var _getRealHole = this.getRealHole(row, column);
	
	      var realRow = _getRealHole.row;
	      var realColumn = _getRealHole.column;
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_AnimatedBoard2.default, _extends({}, this.normalizedProps(this.props), {
	...
	var mapStateToProps = function mapStateToProps(state /*, ownProps*/) {
	  ...
	  var board = _state$gameState.board;
	  var turn = _state$gameState.turn;
	  var animationSteps = _state$gameState.animationSteps;
	
	  return {
	    board: board,
	    turn: turn,
	    animationSteps: animationSteps,
	    isGameOver: (0, _actions.isGameOver)(board),
	    finalScore: (0, _actions.finalScore)(board)
	  };
	};
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch /*, ownProps*/) {
	  return {
	    resetGame: function resetGame() {
	      dispatch((0, _actions.resetGame)());
	    },
	    onHoleClick: function onHoleClick(row, column) {
	      dispatch((0, _actions.emptyHole)(row, column));
	    }
	  };
	};
	
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(PlayersBoard);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _animate = __webpack_require__(216);
	...
	var DURATION = 500; // time bead takes to animate
	var SPACING = 250; // time between each bead animation
	var LINGER = 200; // time to pause after animation is complete
	
	var AnimatedBoard = function (_Component) {
	  _inherits(AnimatedBoard, _Component);
	
	  function AnimatedBoard(props) {
	    _classCallCheck(this, AnimatedBoard);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AnimatedBoard).call(this, props));
	    ...
	    _this.setBucketRef = _this.setBucketRef.bind(_this);
	    return _this;
	  }
	
	  _createClass(AnimatedBoard, [{
	    ...
	    key: 'throttleProps',
	    value: function throttleProps(props, fn) {
	      var _this2 = this;
	      ...
	      if (this.processingProps) {
	        ...
	        fn(props).then(function () {
	          _this2.processingProps = false;
	          var nextProps = _this2.propsQueue.shift();
	          nextProps && _this2.throttleProps(nextProps, fn);
	        });
	      }
	    }
	  }, {
	    ...
	    value: function processProps(nextProps) {
	      ...
	      var animationSteps = nextProps.animationSteps;
	
	      var delayedProps = _objectWithoutProperties(nextProps, ['animationSteps']);
	
	      return this.performAnimations(animationSteps).then(function () {
	        return _this3.setState({ delayedProps: delayedProps });
	      });
	    }
	  }, {
	    key: 'performAnimations',
	    value: function performAnimations(animationSteps) {
	      var _this4 = this;
	
	      var moves = animationSteps.filter(function (a) {
	        return a.type === 'MOVE_BEAD';
	      });
	      var capture = animationSteps.find(function (a) {
	        return a.type === 'CAPTURE_HOLE';
	      });
	
	      var animateMoves = moves.map(this.animateMoveBead, this);
	
	      return Promise.all(animateMoves).then(function (movedBeads) {
	        return movedBeads[movedBeads.length - 1];
	      }).then(function (lastMovedBead) {
	        return capture && _this4.animateCapture(capture, lastMovedBead);
	      }).then(function () {
	        return new Promise(function (resolve) {
	          if (animationSteps.length) setTimeout(resolve, LINGER);else resolve();
	        });
	      });
	    }
	  }, {
	    key: 'animateMoveBead',
	    value: function animateMoveBead(step) {
	      var start = step.start;
	      var end = step.end;
	      var index = step.index;
	
	      var destination = this.getBucket(end);
	      var origin = this.getBucket(start);
	      var invertedIndex = origin.children.length - 1 - index;
	      var bead = origin.children[invertedIndex];
	      bead.style.color = 'red';
	
	      return new Promise(function (resolve) {
	        setTimeout(function () {
	          _animate.animateAppendChild.call(destination, bead, {
	            duration: DURATION,
	            fakeAppend: true
	          }).then(function () {
	            return resolve(bead);
	    ...
	    key: 'animateCapture',
	    value: function animateCapture(step, lastMovedBead) {
	      var hole = step.hole;
	
	      var destination = void 0;
	      var capturedBucket = void 0;
	      if (hole.row === 0) {
	      ...
	      if (capturedBucket.animationClone) {
	        var cloneChildren = capturedBucket.animationClone.children;
	        Array.prototype.forEach.call(cloneChildren, function (node) {
	          return node.animatingNode && animatingBeads.push(node.animatingNode);
	        });
	      }
	
	      var beads = [lastMovedBead].concat(_toConsumableArray(capturedBucket.children), animatingBeads);
	
	      var animations = Array.prototype.map.call(beads, function (bead, index) {
	        return new Promise(function (resolve) {
	    ...
	    key: 'setBucketRef',
	    value: function setBucketRef(row, column, bucket) {
	      this.buckets[row][column] = bucket;
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_Board2.default, _extends({}, this.state.delayedProps, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EndHole = __webpack_require__(190);
	
	var _EndHole2 = _interopRequireDefault(_EndHole);
	
	var _ActiveHoles = __webpack_require__(193);
	
	var _ActiveHoles2 = _interopRequireDefault(_ActiveHoles);
	
	var _GameOverModal = __webpack_require__(195);
	
	var _GameOverModal2 = _interopRequireDefault(_GameOverModal);
	...
	var Board = function (_Component) {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function render() {
	      ...
	      var isGameOver = _props.isGameOver;
	      var finalScore = _props.finalScore;
	      var resetGame = _props.resetGame;
	      var _setBucketRef = _props.setBucketRef;
	      var onHoleClick = _props.onHoleClick;
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'row' },
	        _react2.default.createElement(_EndHole2.default, {
	          className: 'col-sm-offset-2 col-sm-1 text-center',
	          value: board[0][0],
	          setBucketRef: function setBucketRef(bucketRef) {
	            return _setBucketRef(0, 0, bucketRef);
	          }
	        }),
	        _react2.default.createElement(_ActiveHoles2.default, {
	          board: board,
	          turn: turn,
	          setBucketRef: _setBucketRef,
	        ...
	        _react2.default.createElement(_EndHole2.default, {
	          ...
	          setBucketRef: function setBucketRef(bucketRef) {
	            return _setBucketRef(1, board[1].length - 1, bucketRef);
	          }
	        }),
	        _react2.default.createElement(_GameOverModal2.default, {
	          isOpen: isGameOver,
	          score: finalScore,
	          resetGame: resetGame
	        })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnimatedBucket = __webpack_require__(192);
	
	var _AnimatedBucket2 = _interopRequireDefault(_AnimatedBucket);
	...
	var EndHole = function (_Component) {
	  _inherits(EndHole, _Component);
	
	  function EndHole() {
	    _classCallCheck(this, EndHole);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(EndHole).apply(this, arguments));
	  }
	
	  _createClass(EndHole, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      ...
	      var props = _objectWithoutProperties(_props, ['value', 'className']);
	
	      return _react2.default.createElement(
	        'div',
	        { className: (0, _classnames2.default)(className, 'end-hole') },
	        _react2.default.createElement(
	          'button',
	          {
	            className: 'btn btn-default disabled',
	            style: { height: '100%' } },
	          _react2.default.createElement(_AnimatedBucket2.default, _extends({}, props, {
	            value: value
	          })),
	          value
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnimatedBucket = function (_Component) {
	  _inherits(AnimatedBucket, _Component);
	
	  function AnimatedBucket() {
	    _classCallCheck(this, AnimatedBucket);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AnimatedBucket).apply(this, arguments));
	  }
	
	  _createClass(AnimatedBucket, [{
	    key: "componentDidMount",
	    value: function componentDidMount() {
	    ...
	    value: function componentWillUpdate() {
	      var clearAnimation = this.refs.bucket.clearAnimation;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { ref: "bucket", className: "bead-container" },
	        Array(value).fill().map(function (u, i) {
	          return _react2.default.createElement("span", { key: i, className: "glyphicon glyphicon-record" });
	        })
	      );
	    }
	  }]);
	
	  return AnimatedBucket;
	}(_react.Component);
	
	exports.default = AnimatedBucket;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Hole = __webpack_require__(194);
	...
	var ActiveHoles = function (_Component) {
	  _inherits(ActiveHoles, _Component);
	
	  function ActiveHoles() {
	    _classCallCheck(this, ActiveHoles);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActiveHoles).apply(this, arguments));
	  }
	
	  _createClass(ActiveHoles, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	    ...
	    value: function renderColumn(column) {
	      return _react2.default.createElement(
	        'div',
	        { className: 'col-sm-1 text-center', style: { direction: 'rtl' } },
	    ...
	    key: 'renderHole',
	    value: function renderHole(row, column) {
	      var _props = this.props;
	      var _setBucketRef = _props.setBucketRef;
	      var board = _props.board;
	      var turn = _props.turn;
	      ...
	      return _react2.default.createElement(_Hole2.default, {
	        setBucketRef: function setBucketRef(bucketRef) {
	          return _setBucketRef(row, column, bucketRef);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hole = function (_Component) {
	  _inherits(Hole, _Component);
	
	  function Hole() {
	    _classCallCheck(this, Hole);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Hole).apply(this, arguments));
	  }
	  ...
	  _createClass(Hole, [{
	    ...
	    value: function render() {
	      ...
	      var setBucketRef = _props.setBucketRef;
	
	      var props = _objectWithoutProperties(_props, ['onClick', 'value', 'active', 'setBucketRef']);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_AnimatedBucket2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactModal = __webpack_require__(196);
	...
	var GameOverModal = function (_Component) {
	  ...
	  function GameOverModal() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GameOverModal).apply(this, arguments));
	  }
	  ...
	  _createClass(GameOverModal, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['score', 'resetGame']);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h3',
	            null,
	            'Player ' + (score.indexOf(Math.max.apply(Math, _toConsumableArray(score))) + 1) + ' wins!'
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'row' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ariaAppHider = __webpack_require__(214);
	var elementClass = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseAssign = __webpack_require__(204),
...
/***/ function(module, exports) {
	...
	function cloneOffscreen(parent, child) {
	  ...
	  var beforeParent = clonedParent.cloneNode(true);
	  parent.parentNode.appendChild(beforeParent);
	
	  clonedParent.appendChild(clonedChild);
	  parent.parentNode.appendChild(clonedParent);
	
	  return { beforeParent: beforeParent, clonedParent: clonedParent, clonedChild: clonedChild };
	}
	
	function getShiftOfChild(beforeParent, afterParent, index) {
	  var beforeChild = beforeParent.children[index];
	  var afterChild = afterParent.children[index];
	  var deltaX = afterChild.offsetLeft - beforeChild.offsetLeft;
	  var deltaY = afterChild.offsetTop - beforeChild.offsetTop;
	  return { deltaX: deltaX, deltaY: deltaY };
	}
	
	function transform(node, deltaX, deltaY, options) {
	  var effect = ['transform', options.duration + 'ms', options.easing, options.delay + 'ms'].join(' ');
	...
	function addTranlate(node, deltaX, deltaY) {
	  ...
	  var match = transform.match(/translate\((.*)px, (.*)px\)/);
	  if (match) {
	...
	var animateAppendChild = exports.animateAppendChild = function animateAppendChild(node) {
	  var _this = this;
	  ...
	  var _cloneOffscreen = cloneOffscreen(this, node);
	
	  var beforeParent = _cloneOffscreen.beforeParent;
	  var clonedParent = _cloneOffscreen.clonedParent;
	  var clonedChild = _cloneOffscreen.clonedChild;
	
	  var startRect = node.getBoundingClientRect();
	  var parentRect = this.getBoundingClientRect();
	
	  // move the node to it's destination
	  var deltaX = parentRect.left + clonedChild.offsetLeft - startRect.left;
	  var deltaY = parentRect.top + clonedChild.offsetTop - startRect.top;
	  transform(node, deltaX, deltaY, options);
	
	  // move existing sibilings
	  eachChild(this, function (child, i) {
	    if (!beforeParent.children[i]) return;
	    if (clonedParent.children[i].animatingNode) return;
	
	    var _getShiftOfChild = getShiftOfChild(beforeParent, clonedParent, i);
	
	    var deltaX = _getShiftOfChild.deltaX;
	    var deltaY = _getShiftOfChild.deltaY;
	
	    var delay = options.delay + options.duration / 2;
	    var alreadyTransformed = !!child.style.transform;
	    transform(child, deltaX, deltaY, _extends({}, options, {
	  ...
	  eachChild(clonedParent, function (child, i) {
	    if (child === clonedChild) return;
	    if (!child.animatingNode) return;
	
	    var _getShiftOfChild2 = getShiftOfChild(beforeParent, clonedParent, i);
	
	    var deltaX = _getShiftOfChild2.deltaX;
	    var deltaY = _getShiftOfChild2.deltaY;
	  ...
	  this.clearAnimation = function () {
	    //clean up
	    clonedParent.remove();
	    delete _this.animationClone;
	
	    options.fakeAppend || resetTransform(node);
	    eachChild(_this, resetTransform);
	    options.fakeAppend || _this.appendChild(node);
	
	    delete _this.clearAnimation;
	  };
...
/***/ function(module, exports) {
	...
	var EMPTY_HOLE = exports.EMPTY_HOLE = 'EMPTY_HOLE';
	...
	var emptyHole = exports.emptyHole = function emptyHole(row, column) {
	  return {
	    type: EMPTY_HOLE,
	    row: row,
	    column: column
	...
	var resetGame = exports.resetGame = function resetGame() {
	  return {
	    type: RESTART_GAME
	  };
	};
	...
	var isGameOver = exports.isGameOver = function isGameOver(board) {
	  return board[0].reduce(sum, 0) === board[0][0] || board[1].reduce(sum, 0) === board[1][board[1].length - 1];
	};
	
	var finalScore = exports.finalScore = function finalScore(board) {
	  return [board[0].reduce(sum, 0), board[1].reduce(sum, 0)];
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.onPlayerNumber = onPlayerNumber;
	
	var _firebase = __webpack_require__(219);
	
	// assign player number.
	_firebase.rootRef.onAuth(function (authData) {
	  if (!authData) return;
	  var playersRef = _firebase.rootRef.child('players');
	  playersRef.on('value', function (snapshot) {
	    var players = snapshot.val();
	    if (!players || !players[authData.uid]) {
	      var numPlayers = snapshot.numChildren();
	      if (numPlayers < 2) {
	        var playerNumber = numPlayers;
	        if (numPlayers === 1) {
	          var otherPlayersId = Object.keys(snapshot.val())[0];
	          var otherPlayer = players[otherPlayersId];
	          var otherPlayersNumber = otherPlayer.playerNumber;
	          playerNumber = otherPlayersNumber === 0 ? 1 : 0;
	        }
	        playersRef.child(authData.uid).onDisconnect().remove();
	        playersRef.child(authData.uid).set({ playerNumber: playerNumber });
	...
	function onPlayerNumber(cb) {
	  _firebase.rootRef.onAuth(function (authData) {
	    if (!authData) return cb(-1);
	    _firebase.rootRef.child('players').child(authData.uid).child('playerNumber').on('value', function (snapshot) {
	      if (typeof snapshot.val() !== 'undefined') return cb(snapshot.val());
	      cb(-1);
	    });
	  });
	}
	...
	var user = _firebase.rootRef.getAuth();
	if (!user) {
	  _firebase.rootRef.authAnonymously(function (error) {
	    if (error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.rootRef = undefined;
	
	var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
	
	exports.firebaseMiddleware = firebaseMiddleware;
	exports.skipPreviousAnimations = skipPreviousAnimations;
	
	var _firebase = __webpack_require__(220);
	...
	var rootRef = exports.rootRef = new _firebase2.default(_config.FIREBASE_URL);
	
	var childAddedQueue = function childAddedQueue(dispatch) {
	  ...
	  return function (snapshot, prevSnapKey) {
	    if (lastKey === prevSnapKey) {
	      do {
	        delete queuedSnapshots[lastKey];
	        lastKey = snapshot.key();
	        dispatch(_extends({}, snapshot.val(), { firebaseUpdate: true }));
	...
	function firebaseMiddleware(_ref) {
	  ...
	  return function (next) {
	    return function (action) {
	      var firebaseUpdate = action.firebaseUpdate;
	      ...
	      if (firebaseUpdate) {
	        ...
	        var _getState$gameState = getState().gameState;
	        var board = _getState$gameState.board;
	        var turn = _getState$gameState.turn;
	
	        rootRef.child('gameState').update({ board: board, turn: turn });
	        return returnValue;
	      } else {
	        // Don't generate a new state here. Instead allow
	        // firebase to dispatch the action.
	        if (action.type === 'RESTART_GAME') resetMoves(dispatch);
	...
	function skipPreviousAnimations() {
	  var skipCount = 0;
	
	  var fetch = new Promise(function (resolve) {
	    rootRef.child('moves').once('value', function (snapshot) {
...
/***/ function(module, exports) {
	...
	var FIREBASE_URL = exports.FIREBASE_URL = 'https://codr-mancala.firebaseio.com/';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameState = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MoveRecorder = __webpack_require__(224);
	
	var _MoveRecorder2 = _interopRequireDefault(_MoveRecorder);
	...
	function gameState() {
	  ...
	  switch (action.type) {
	    case _actions.EMPTY_HOLE:
	      var board = cloneBoard(state.board);
	      var recorder = new _MoveRecorder2.default(action);
	      var lastPiece = moveHole({ board: board, turn: state.turn }, action.row, action.column, recorder.moveBead);
	      var turn = getNextTrun(state, action.row, action.column);
	      if (shouldCapture({ board: board, turn: state.turn }, lastPiece)) {
	...
	function moveRecursive(_ref, row, column, count, record) {
	  var board = _ref.board;
	  var turn = _ref.turn;
	
	  if (count === 0) return { row: row, column: column };
	  if (row === 0) {
	    // move left
	    if (column > 0) {
	      column--;
	  ...
	  return moveRecursive({ board: board, turn: turn }, row, column, count - 1, record);
	}
	...
	function shouldCapture(_ref2) {
	  ...
	  return turn === row && board[row][column] === 1 && !isScoreHole({ row: row, column: column });
	}
	
	function capture(board, _ref4) {
	  var row = _ref4.row;
	...
	function isScoreHole(_ref5) {
	  var row = _ref5.row;
	  var column = _ref5.column;
	
	  return row === 0 && column === 0 || row === 1 && column === 6;
	}
...
/***/ function(module, exports) {
	...
	var MoveRecorder = function () {
	  function MoveRecorder(_ref) {
	    var row = _ref.row;
	    var column = _ref.column;
	
	    _classCallCheck(this, MoveRecorder);
	
	    this.origin = { row: row, column: column };
	    this.steps = [];
	  ...
	  _createClass(MoveRecorder, [{
	    key: 'moveBead',
	    value: function moveBead(row, column, index) {
	      this.steps.push({
	        type: 'MOVE_BEAD',
	        start: this.origin,
